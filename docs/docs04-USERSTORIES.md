...
| G-03 | Ingin melihat daftar Guru dan Data Karyawan sekolah. | ✔ Guru dan Karyawan tersedia pada halaman terpisah menggunakan carousel horizontal responsif. Pada desktop ditampilkan tiga kartu dengan kartu aktif berada di tengah dan tampil lebih menonjol. Carousel mendukung autoplay, pause saat pointer berada pada area carousel, drag menggunakan mouse, swipe pada perangkat sentuh, serta navigasi manual yang aksesibel. Kartu profil dapat menampilkan foto, nama, riwayat pendidikan, jabatan, serta mata pelajaran atau bagian/unit jika tersedia. Halaman Guru menampilkan Kepala Sekolah sebagai slide awal, sedangkan halaman Karyawan mengikuti urutan tampil data aktif. |
...
| G-07 | Ingin melihat fasilitas sarana dan prasarana sekolah serta informasi detail setiap fasilitas. | ✔ Grid fasilitas tampil rapi dan responsif. Setiap fasilitas dapat dibuka menuju halaman detail yang menampilkan foto utama, deskripsi, serta maksimal 2 foto dokumentasi tambahan apabila tersedia. Halaman detail tetap tampil dengan baik jika hanya tersedia foto utama. |
...
| G-13 | Ingin mengetahui Program Unggulan dan keterampilan praktis yang dapat dikembangkan siswa di sekolah. | ✔ Tersedia satu landing page Program Unggulan yang dapat diakses tanpa login. Halaman menampilkan program aktif berdasarkan urutan tampil, penjelasan manfaat secara profesional, foto utama kegiatan, dan maksimal 2 foto dokumentasi tambahan apabila tersedia. Informasi tidak membuat klaim mengenai sertifikasi, jaminan kerja, penyaluran kerja, atau mitra tertentu tanpa data resmi dari sekolah. |
...
| A-05 | Ingin melakukan CRUD Prestasi, Ekstrakurikuler, dan Fasilitas. | ✔ Form manajemen data menyediakan upload foto sesuai kebutuhan masing-masing entitas. Pada Fasilitas, admin dapat mengelola satu foto utama dan maksimal 2 foto dokumentasi tambahan. |
...
| A-10 | Ingin mengelola Data Guru dan Data Karyawan. | ✔ Admin dapat menambah, mengubah, dan menghapus data staf menggunakan satu modul backend dengan kategori Guru atau Karyawan, termasuk nama, foto opsional, jabatan, mata pelajaran atau bagian/unit, status aktif, urutan tampil, serta satu atau lebih riwayat pendidikan yang dapat dikelola secara terstruktur. |
...
| A-12 | Ingin mengelola Program Unggulan yang ditampilkan pada website. | ✔ Admin dapat mengelola pengantar halaman dan informasi umum kolaborasi LPK/BLK serta menambah, mengubah, menghapus, mengaktifkan atau menonaktifkan, dan mengatur urutan bidang Program Unggulan. Setiap program dapat memiliki nama, ringkasan, deskripsi/manfaat, foto utama, status aktif, urutan tampil, serta maksimal 2 foto dokumentasi tambahan dengan teks alternatif dan urutan dokumentasi. |
...
## 4. Kriteria Non-Fungsional Utama & Masa Depan
 ...
 Optimasi Media: Gambar yang digunakan untuk tampilan website, termasuk foto utama dan dokumentasi Program Unggulan, dioptimasi ke format WebP menggunakan fondasi pemrosesan media yang tersedia. File asli yang memang disediakan sebagai file unduhan pada Kurikulum dan SPMB tetap dipertahankan.
